...
const dataUrl = (f) => {
  ...
  return `data:${mime};base64,${readFileSync(join(here, 'assets', f)).toString('base64')}`;
};
const jsWithArt = js.replaceAll('__ART_TAHOE_T16__', () => dataUrl('vessels/tahoe-t16-1400.jpg'));
const html = readFileSync(join(here, 'template.html'), 'utf8')
  ...
  .replaceAll('__ART_TAHOE_T16__', () => dataUrl('vessels/tahoe-t16-1400.jpg'))
  .replace('/*__BUNDLE__*/', () => jsWithArt);
